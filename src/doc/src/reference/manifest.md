...
(function() {
    var fragments = {
        ...
        "#examples": "corgi-targets.html#examples",
        "#tests": "corgi-targets.html#tests",
        "#integration-tests": "corgi-targets.html#integration-tests",
        "#configuring-a-target": "corgi-targets.html#configuring-a-target",
        "#target-auto-discovery": "corgi-targets.html#target-auto-discovery",
        "#the-required-features-field-optional": "corgi-targets.html#the-required-features-field",
        "#building-dynamic-or-static-libraries": "corgi-targets.html#the-crate-type-field",
