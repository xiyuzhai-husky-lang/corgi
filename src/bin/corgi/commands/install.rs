...
pub fn cli() -> Command {
    subcommand("install")
        .about("Install a Rust binary. Default location is $HOME/.corgi/bin")
        .arg_quiet()
        .arg(
            Arg::new("crate")
        ...
        .arg_message_format()
        .arg_timings()
        .after_help("Run `corgi help install` for more detailed information.\n")
}
...
pub fn exec(config: &mut Config, args: &ArgMatches) -> CliResult {
    ...
    // but in these particular cases we need it to fix rust-lang/corgi#10283.
