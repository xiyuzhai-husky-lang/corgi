...
fn output_on_stable() {
    ...
    p.cargo("check")
        ...
        .with_stderr_contains("[..]corgi report[..]")
        .run();
}
...
fn test_multi_crate() {
    ...
    // for the id in a line of the form "run `corgi report future-incompatibilities --id yZ7S`"
...
fn suggestions_for_updates() {
    ...
    // This is a hack to force corgi to update the index. Cargo can't do this
